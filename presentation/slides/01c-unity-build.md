...
**CMAKE_UNITY_BUILD=ON** writes unity_N.cxx files that #include **CMAKE_UNITY_BUILD_BATCH_SIZE** sources each, 8 by default: eight compile edges become one, headers parsed once — and one edit recompiles all eight.
