...
declared only in 205 of 218 copies.
...
::: tiny
The other probe, `cstring::size()`: named by every unit, kept in every copy, 194 PCHs and 9689 pieces recompile, 684.1s. What can be declared only decides the row.
:::
