...
Shared global module fragment with {accent}preamble{/accent}.
...
::: rationale
Each moved body compiled as an implementation unit under its own interface, with the global module fragment replayed: the BMI never carries the body.
:::
