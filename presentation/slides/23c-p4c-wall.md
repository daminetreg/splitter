...
- no-op | 0.2 | 0.2 | 0.2
- source touch | 3.7 | 10.0 | 0.6
- header touch | 106.8 | 63.6 | 19.4
- one body | 102.6 | 63.9 | 23.0
:::

::: tiny
Each bar is value ÷ this set’s 965.5s maximum. Build phase only, `-j16`, one run. One body is `cstring::findlast()`; `cstring::size()` reads 684.1s for the split, the same for plain and unity.
:::
